...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    decrementProductInventory(state, payload) {
      ...
      product.quantity--;
      /**
       * in decrementProductInventory, use the "find" method
       * to pick out the correct product with an id that matches our payload (a product id)
       * Use decrementing shorthand to substract one from the value stored at product quantity
       */
    },
  ...
  actions: {
    addToCart({ commit }, payload) {
      //addToCart triggers 2 mutations:
      //add the product id to teh cart & decrement product inventory
      commit("addToCart", payload); //paylaod == product id
      commit("decrementProductInventory", payload); // a second mutation
    },
  ...
  getters: {
    ...
    cartItems: (state) => {
      ...
      /**
       * For each itemId in the cart, it should look in the products array
       * to find and return the product whose id is a match
       */
    },
