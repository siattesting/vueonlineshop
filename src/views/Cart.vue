            ...
            <div class="flex-col">
                <ul class="cart-list">
                    <li class="flex-col cart-list__item" v-for="item in cartItems" :key="item.id">
                        ...
                        <div class="flex-col cart-list__item__details">
                            ...
                            <button class="btn cart-list__btn-remove" @click="removeFromCart(item.id)">Remove</button>
                        </div>
                    </li>
                </ul>
                <section class="total-section">
                    <ul class="total-section-list">
                        ...
                        <li class="total-section__item" v-if="salesTaxApplied">
                            <p class="total-section__item__label">Sales Tax Applied: <span>{{salesTaxPercentage}}</span></p>
                            <p>{{ salesTaxApplied }}</p>
                        </li>
                    ...
                    <button :disabled="!this.selectedShippingOption" 
                            class="btn btn--grey total-section__checkout-button">Check out
                    </button>
                </section>
            </div>
...
export default {
    ...
    computed: {
        cartItems() {
            //Gather cart items from the app store into an array
        ...
        // itemQuantity() {
        //     return this.cartItems.reduce(function(itemQuantity, item) {
        //         if(item in itemQuantity) {
        //             itemQuantity[item]++
        //         }
        //         else {
        //             itemQuantity[item] = 1;
